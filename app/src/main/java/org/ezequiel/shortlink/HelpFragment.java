...
public class HelpFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       fragmentHelpBinding =   FragmentHelpBinding.inflate(inflater, container, false);
        ...
        fragmentHelpBinding.webViewHelp.getSettings().setJavaScriptEnabled(true);
        fragmentHelpBinding.webViewHelp.getSettings().setBuiltInZoomControls(true);
        fragmentHelpBinding.webViewHelp.getSettings().setSupportZoom(true);
        fragmentHelpBinding.webViewHelp.loadUrl("file:///android_asset/help.html");
